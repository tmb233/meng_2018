...
/**
* \def MBEDTLS_CRYPTOCELL_SUPPORT
*
* The platform supports CryptoCell.
*
* Requires CryptoCell library to operate.
*
* Used in:
*      library/ecp.c
*
* Comment to disable the use of CryptoCell.
*/
#define MBEDTLS_CRYPTOCELL_SUPPORT
