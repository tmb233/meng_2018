...
#if defined(MBEDTLS_CRYPTOCELL_SUPPORT)
...
extern CRYS_RND_Context_t  * pRndContext;
...
#endif /* MBEDTLS_CRYPTOCELL_SUPPORT */
                                  ...
                                  const mbedtls_mpi *m, const mbedtls_ecp_point *P )
{
    ...
    CRYSError_t error = PkaEcWrstScalarMult( pDomain, scalar, orderSizeInWords,
                                       ...
                                       mbedtls_mpi *d, mbedtls_ecp_point *Q )
{
    ...
    *domain = *CRYS_ECPKI_GetEcDomain( grp_id );
    ...
    uint32_t orderSizeInWords = ( domain->ordSizeInBits + ( 8 * sizeof( uint32_t ) ) - 1 ) /
                                ( 8 * sizeof( uint32_t ) );
    ...
    CRYSError_t error = CRYS_ECPKI_GenKeyPair( pRndContext, domain, UserPrivKey, UserPublKey,
