                                          ...
                                          nfc_ndef_msg_desc_t           ** pp_meshcop_msg_desc)
{
    ...
    if (p_meshcop_data != NULL)
    {
        ...
        err_code = nfc_ndef_msg_record_add(&NFC_NDEF_MSG(nfc_meshcop_msg), p_meshcop_rec);
    ...
    *pp_meshcop_msg_desc = &NFC_NDEF_MSG(nfc_meshcop_msg);
